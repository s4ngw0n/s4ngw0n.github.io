...
\begin{minipage}[t]{0.75\linewidth}
  ...
  \begin{tabular}{@{}c@{\enspace}l@{}c@{\enspace}l@{}}
    ...
    $\cdot$ & Office   & : & Room 211, Building E6-6, KAIST\\
...
\entry{2019/02/25 - 2026/08/21}{Ph.D.\ in Physics, Korea Advanced Institute of Science and Technology, Korea\\
$\cdot$ Advisor: Andrey S. Moskalenko\\
$\cdot$ Thesis: Quasiclassical theory of nonadiabatic tunneling in nanocontacts driven by \\classical and quantum light}
\entry{2014/03/01 - 2019/02/24}{B.S.\ in Physics, Korea Advanced Institute of Science and Technology, Korea}

\section*{Professional Experience}
\settowidth{\entrywidth}{0000/00/00 - 0000/00/00\quad\enspace}

\entry{2026/09/01 - 2027/08/31}{Post-doctoral Researcher\\
TUQP, Korea Advanced Institute of Science and Technology, Korea}
...
\cvitem{2}{QAMTS 2024 at Donostia-San Sebastián, Spain (June 16 - 21, 2024)\\
Quasiclassical approach to dynamical aspects of tunneling
in nanocontacts induced by ultrashort light pulses}
\cvitem{1}{OPC 2021 at Jeju, Korea (July 4 - 7, 2021)\\
...
\cvitem{7}{UP 2026\\ Sapporo, Japan (August 2 - 7, 2026)}
\cvitem{6}{ALTA 2026\\ Jeju, Korea (May 6 - 9, 2026)}
\cvitem{5}{ALTA 2024\\ Jeju, Korea (May 1 - 4, 2024)}
\cvitem{4}{GRC Ultrafast Phenomena in Cooperative Systems\\ Lucca (Barga), Italy (February 4 - 9, 2024)}
\cvitem{3}{ALTA 2023\\ Jeju, Korea (May 1 - 4, 2003)}
\cvitem{2}{ICAMD 2021\\ Jeju, Korea (December 6 - 10, 2021)}
...
\cvitem{5}{Fully audited (participated all course activies including homeworks, quizzes and exams) the following courses:\\
$\cdot$ Modern Algebra I (MAS311, Department of Mathematical Sciences, KAIST)\\
$\cdot$ Introduction to Differential Geometry (MAS321, Department of Mathematical Sciences, KAIST)\\
$\cdot$ Complex Function Theory (MAS541, Department of Mathematical Sciences, KAIST)
}
